...
final class RallyClosureService
{
    ...
    private function closeUnderLock(CombatInstance $combat, int $openedAt, int $closedAt): RallyClosureOutcome
    {
        ...
        $this->engagement->engage($combat, $closedAt, $photographie->protectedResources, $photographie->photographedGarrison, $photographie->photographedDefender, $photographie->photographedUniverse);
