...
final class LifeformPlanetUpdater
{
    ...
    public function update(PlanetService $planet, int $now): void
    {
        ...
        // **Le passage ne depasse jamais l echeance d une bataille non reglee.** Un combat durable est
        // date de son echeance et regle apres ; si la planete la franchissait avant le reglement, elle
        // livrerait un travail et demarrerait le suivant sur une population que la bataille allait tuer —
