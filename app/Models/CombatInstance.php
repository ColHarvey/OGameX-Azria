 ...
 * @property array<mixed>|null $report_participants
 ...
 * @property string|null $hamill_rule_version La regle de la manoeuvre de Hamill : v1, telle que livree (inerte sous le moteur Rust) ; v2, effective dans les deux moteurs ; v3, l Etoile detruite quitte aussi le decompte des survivants.
