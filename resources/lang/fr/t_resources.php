...
return [
    ...
    'deuterium_synthesizer' => [
        ...
        'description_long' => 'Le deutérium est également appelé hydrogène lourd. C\'est un isotope stable de l\'hydrogène avec une abondance naturelle dans les océans des colonies d\'environ un atome sur 6 500 d\'hydrogène (~ 154 PPM). Le deutérium représente donc environ 0,015 % (en poids, 0,030 %) du total. Le deutérium est traité par des synthétiseurs spéciaux qui peuvent séparer l\'eau du deutérium à l\'aide de centrifugeuses spécialement conçues. La mise à niveau du synthétiseur permet d\'augmenter la quantité de dépôts de deutérium traités. Le deutérium est utilisé pour effectuer des analyses de phalanges de capteurs, pour observer des galaxies, comme carburant pour les vaisseaux et pour effectuer des mises à niveau de recherche spécialisées.',
    ],
    'solar_plant' => [
...
Le Hangar de cristal protège un certain pourcentage de la production quotidienne de la mine (max. 10 pour cent).',
    ],
    'deuterium_store' => [
...
Le réservoir de deutérium protège un certain pourcentage de la production quotidienne du synthétiseur (max. 10 pour cent).',
    ...
    'robot_factory' => [
        ...
        'description_long' => 'L\'objectif principal de Usine de robots est la production de robots de construction de pointe. Chaque mise à niveau de l\'usine robotique entraîne la production de robots plus rapides, utilisés pour réduire le temps nécessaire à la construction des bâtiments.',
    ],
    'shipyard' => [
        'title' => 'Chantier spatial',
        'description' => 'Tous les types de vaisseaux et d\'installations défensives sont construits dans le chantier spatial planétaire.',
        'description_long' => 'Le chantier spatial planétaire est responsable de la construction d\'engins spatiaux et de mécanismes défensifs. Au fur et à mesure que le chantier spatial se modernise, il peut produire une plus grande variété de véhicules à une vitesse beaucoup plus élevée. Si une usine de nanites est présente sur la planète, la vitesse à laquelle les vaisseaux sont construits est considérablement augmentée.',
    ],
    'research_lab' => [
    ...
    'nano_factory' => [
        ...
        'description' => 'C\'est le nec plus ultra de la technologie robotique. Chaque niveau réduit le temps de construction des bâtiments, des vaisseaux et des défenses.',
        'description_long' => 'Une nanomachine, également appelée nanite, est un dispositif mécanique ou électromécanique dont les dimensions sont mesurées en nanomètres (millionièmes de millimètre, ou unités de 10^-9 mètres). La taille microscopique des nanomachines se traduit par une vitesse opérationnelle plus élevée. Cette usine produit des nanomachines qui constituent l’évolution ultime de la technologie robotique. Une fois construite, chaque mise à niveau réduit considérablement le temps de production des bâtiments, des vaisseaux et des structures défensives.',
    ],
    'terraformer' => [
        'title' => 'Terraformeur',
...
Les réparations doivent commencer dans les 3 jours suivant la création de l\'épave. Les vaisseaux réparés doivent être remis en service manuellement une fois les réparations terminées. Si cela n’est pas fait, les vaisseaux individuels de tout type seront remis en service après 3 jours.

L\'épave n\'apparaît que si plus de 150 000 unités ont été détruites, y compris ses propres vaisseaux ayant pris part au combat pour une valeur d\'au moins 5 % des points du vaisseau.
...
Une fois qu’un niveau suffisant de technologie hyperspatiale est recherché, l’Propulsion hyperespace n’est plus seulement une théorie. Chaque amélioration de ce moteur augmente la capacité de chargement de vos vaisseaux de 5 % de la valeur de base.',
    ],
    'plasma_technology' => [
...
La production de métaux augmente de 1 %, la production de cristaux de 0,66 % et la production de deutérium de 0,33 % par niveau de construction de la technologie plasma.',
    ...
    'combustion_drive' => [
        ...
        'description_long' => 'Le Réacteur à combustion est la plus ancienne des technologies, mais il est toujours utilisé. Avec le Réacteur à combustion, les gaz d\'échappement sont formés à partir des propulseurs transportés à l\'intérieur du vaisseau avant utilisation. Dans une enceinte fermée, les pressions sont égales dans chaque direction et aucune accélération ne se produit. Si une ouverture est prévue au fond de la chambre alors la pression ne s\'oppose plus de ce côté. La pression restante donne une poussée résultante dans le côté opposé à l\'ouverture, qui propulse le vaisseau vers l\'avant en expulsant les gaz d\'échappement vers l\'arrière à une vitesse extrêmement élevée.

À chaque niveau de Réacteur à combustion développé, la vitesse des petits et grands cargos, des chasseurs légers, des recycleurs et des sondes d\'espionnage est augmentée de 10 %.',
    ],
    'impulse_drive' => [
...
Les missiles interplanétaires voyagent également plus loin à chaque niveau.',
    ...
    'hyperspace_drive' => [
        ...
        'description_long' => 'A proximité immédiate du vaisseau, l\'espace est déformé de sorte que de longues distances peuvent être parcourues très rapidement. Plus la Propulsion hyperespace est développée, plus la nature déformée de l\'espace est forte, ce qui fait que la vitesse des vaisseaux qui en sont équipés (Traqueurs, Vaisseaux de bataille, Destructeurs, Étoiles de la mort, Éclaireurs et Faucheurs) augmente de 30 % par niveau. De plus, le bombardier est construit avec une Propulsion hyperespace dès que la recherche atteint le niveau 8. Dès que la recherche Propulsion hyperespace atteint le niveau 15, le Recycleur est rééquipé d\'une Propulsion hyperespace.',
    ],
...
La technologie d’espionnage améliore également les chances de localiser les flottes étrangères. Le niveau d’espionnage est essentiel pour déterminer cela. À partir du niveau 2, le nombre total exact de vaisseaux attaquants est affiché ainsi que la notification d\'attaque normale. Et à partir du niveau 4, le type de vaisseaux attaquants ainsi que leur nombre total sont affichés et à partir du niveau 8, le nombre exact de types de vaisseaux différents est affiché.
...
Pour fonctionner, chaque colonie doit pouvoir mener les recherches de manière indépendante.',
    ...
    'graviton_technology' => [
        ...
        'description' => 'Le tir d’une charge concentrée de particules de gravitons peut créer un champ de gravité artificiel pouvant détruire des vaisseaux ou même des lunes.',
        'description_long' => 'Un graviton est une particule élémentaire sans masse et sans charge. Il détermine la puissance gravitationnelle. En tirant une charge concentrée de gravitons, un champ gravitationnel artificiel peut être construit. Un peu comme un trou noir, il attire la masse en lui. Ainsi, il peut détruire des vaisseaux et même des lunes entières. Pour produire une quantité suffisante de gravitons, il faut d’énormes quantités d’énergie. Graviton Research est nécessaire pour construire une Étoile de la mort destructrice.',
    ],
    'weapon_technology' => [
        ...
        'description_long' => 'La technologie des armes est une technologie de recherche clé et est essentielle à votre survie contre les empires ennemis. À chaque niveau de technologie d\'armes étudié, les systèmes d\'armes des vaisseaux et vos mécanismes de défense deviennent de plus en plus efficaces. Chaque niveau augmente la force de base de vos armes de 10 % de la valeur de base.',
    ],
    'shielding_technology' => [
        'title' => 'Technologie Bouclier',
        'description' => 'La technologie des boucliers rend les boucliers des vaisseaux et des installations défensives plus efficaces. Chaque niveau de technologie de bouclier augmente la force des boucliers de 10 % de la valeur de base.',
        'description_long' => 'Avec l\'invention du générateur de magnétosphère, les scientifiques ont appris qu\'un bouclier artificiel pouvait être produit pour protéger l\'équipage des vaisseaux spatiaux non seulement contre le rude environnement de rayonnement solaire dans l\'espace lointain, mais également pour assurer une protection contre les tirs ennemis lors d\'une attaque. Une fois que les scientifiques ont finalement perfectionné la technologie, un générateur de magnétosphère a été installé sur tous les vaisseaux et systèmes de défense.
...
As the technology is advanced to each level, the magnetosphere generator is upgraded which provides an additional 10% strength to the shields base value.',
    ...
    'armor_technology' => [
        ...
        'description' => 'Des alliages spéciaux améliorent le blindage des vaisseaux et des structures défensives. L\'efficacité de l\'armure peut être augmentée de 10 % par niveau.',
    ...
    'small_cargo' => [
        ...
        'description_long' => 'Les transporteurs sont à peu près aussi gros que les chasseurs, mais ils renoncent aux systèmes de propulsion hautes performances et aux armements embarqués pour gagner en capacité de transport. En conséquence, un transporteur ne devrait être envoyé au combat que s\'il est accompagné de vaisseaux prêts au combat.

Dès que le Réacteur à impulsion atteint le niveau de recherche 5, le petit transporteur se déplace avec une vitesse de base accrue et est équipé d\'un Réacteur à impulsion.',
    ],
    'large_cargo' => [
        ...
        'description_long' => 'Au fil du temps, les raids sur les colonies ont entraîné la capture de quantités de ressources de plus en plus importantes. En conséquence, de petites cargaisons étaient envoyées en masse pour compenser les captures plus importantes. On s\'est vite rendu compte qu\'une nouvelle classe de vaisseaux était nécessaire pour maximiser les ressources capturées lors des raids, tout en étant également rentable. Après de nombreux développements, le Grand transporteur était né.

Pour maximiser les ressources pouvant être stockées dans les cales, ce vaisseau dispose de peu d\'armes ou d\'armures. Grâce au moteur à combustion hautement développé installé, il constitue le fournisseur de ressources le plus économique entre les planètes et le plus efficace lors des raids sur des mondes hostiles.',
    ],
    'colony_ship' => [
        'title' => 'Vaisseau de colonisation',
        'description' => 'Les planètes vacantes peuvent être colonisées avec ce vaisseau.',
        'description_long' => 'Au XXe siècle, l’Homme décide de viser les étoiles. Premièrement, il atterrissait sur la Lune. Après cela, une station spatiale a été construite. Mars a été colonisée peu de temps après. Il fut vite établi que notre croissance dépendait de la colonisation d’autres mondes. Des scientifiques et des ingénieurs du monde entier se sont réunis pour développer la plus grande réussite de l’homme. Le vaisseau de colonie est né.

Ce vaisseau est utilisé pour préparer une planète nouvellement découverte à la colonisation. Une fois arrivé à destination, le vaisseau est instantanément transformé en espace de vie habituel pour aider à peupler et à exploiter le nouveau monde. Le nombre maximum de planètes est ainsi déterminé par les progrès de la recherche en astrophysique. Deux nouveaux niveaux d\'astrotechnologie permettent la colonisation d\'une planète supplémentaire.',
    ],
    'recycler' => [
        'title' => 'Recycleur',
        'description' => 'Les recycleurs sont les seuls vaisseaux capables de récolter les champs de débris flottant sur l\'orbite d\'une planète après un combat.',
        'description_long' => 'Les combats dans l’espace prirent une ampleur toujours plus grande. Des milliers de vaisseaux ont été détruits et les ressources de leurs restes semblaient perdues à jamais dans les champs de débris. Les cargos normaux ne pouvaient pas s\'approcher suffisamment de ces champs sans risquer des dommages importants.
Un développement récent des technologies de bouclier a contourné efficacement ce problème. Une nouvelle classe de vaisseaux similaires aux Transporteurs fut créée : les Recycleurs. Leurs efforts ont permis de rassembler les ressources que l’on pensait perdues, puis de les récupérer. Les débris ne représentaient plus de réel danger grâce aux nouveaux boucliers.

Dès que la recherche Réacteur à impulsion a atteint le niveau 17, les recycleurs sont rééquipés d\'un Réacteur à impulsion. Dès que la recherche Propulsion hyperespace a atteint le niveau 15, les recycleurs sont rééquipés d\'une Propulsion hyperespace.',
    ],
    'espionage_probe' => [
...
Grâce à leur bon rapport coût/performance, les satellites solaires peuvent résoudre de nombreux problèmes énergétiques. Mais attention : les satellites solaires peuvent être facilement détruits au combat.',
    ...
    'light_fighter' => [
        ...
        'description' => 'C\'est le premier vaisseau de combat que tous les empereurs construiront. Le chasseur léger est un vaisseau agile, mais vulnérable en soi. En grand nombre, ils peuvent devenir une grande menace pour n’importe quel empire. Ils sont les premiers à accompagner des petites et grandes cargaisons vers des planètes hostiles dotées de défenses mineures.',
        'description_long' => 'C\'est le premier vaisseau de combat que tous les empereurs construiront. Le chasseur léger est un vaisseau agile, mais vulnérable lorsqu\'il est seul. En grand nombre, ils peuvent devenir une grande menace pour n’importe quel empire. Ils sont les premiers à accompagner des petites et grandes cargaisons vers des planètes hostiles dotées de défenses mineures.',
    ],
    'heavy_fighter' => [
...
Légèrement plus grand que le chasseur léger, le chasseur lourd a une coque plus épaisse, offrant plus de protection et un armement plus puissant.',
    ...
    'cruiser' => [
        ...
        'description_long' => 'Avec le développement du laser lourd et du canon à ions, les chasseurs légers et lourds ont subi un nombre alarmant de défaites, qui augmentait à chaque raid. Malgré de nombreuses modifications, changements de puissance des armes et de blindage, il n\'a pas pu être augmenté assez rapidement pour contrer efficacement ces nouvelles mesures défensives. Par conséquent, il a été décidé de construire une nouvelle classe de vaisseaux combinant plus de blindage et plus de puissance de feu. Après des années de recherche et de développement, le Croiseur est né.

Les croiseurs sont dotés d\'un blindage près de trois fois supérieur à celui des chasseurs lourds et possèdent une puissance de feu plus de deux fois supérieure à celle de n\'importe quel vaisseau de combat existant. Ils possèdent également des vitesses qui dépassent de loin n’importe quel vaisseau spatial jamais construit. Pendant près d’un siècle, les croiseurs ont dominé l’univers. Cependant, avec le développement des canons Gauss et des tourelles à plasma, leur prédominance a pris fin. Ils sont encore utilisés aujourd’hui contre des groupes de combattants, mais de manière moins prédominante qu’auparavant.',
    ],
    'battle_ship' => [
        ...
        'description_long' => 'Une fois qu\'il est devenu évident que le croiseur perdait du terrain face au nombre croissant de structures de défense auxquelles il était confronté, et avec la perte de vaisseaux en mission à des niveaux inacceptables, il a été décidé de construire un vaisseau capable d\'affronter ce même type de structures de défense avec le moins de pertes possible. Après un développement approfondi, le Vaisseau de bataille était né. Construit pour résister aux plus grandes batailles, le cuirassé dispose de grands espaces de chargement, de canons lourds et d\'une vitesse d\'hyperpropulsion élevée. Une fois développé, il s’est finalement avéré être l’épine dorsale de chaque flotte de raid de l’Empereur.',
    ],
    'battlecruiser' => [
        'title' => 'Traqueur',
        'description' => 'Le Traqueur est hautement spécialisé dans l\'interception des flottes hostiles.',
        'description_long' => 'Ce vaisseau est l\'un des vaisseaux de combat les plus avancés jamais développés, et il est particulièrement mortel lorsqu\'il s\'agit de détruire les flottes attaquantes. Avec ses canons laser améliorés à bord et son moteur Hyperspace avancé, le Traqueur est une force sérieuse à affronter lors de toute attaque. En raison de la conception du vaisseau et de son système d\'armes de grande taille, les soutes ont dû être réduites, mais cela a été compensé par une consommation de carburant réduite.',
    ],
    'bomber' => [
        'title' => 'Bombardier',
        'description' => 'Le bombardier a été développé spécialement pour détruire les défenses planétaires d\'un monde.',
        'description_long' => 'Au fil des siècles, alors que les défenses commençaient à devenir plus grandes et plus sophistiquées, les flottes commençaient à être détruites à un rythme alarmant. Il a été décidé qu\'un nouveau vaisseau était nécessaire pour briser les défenses et garantir des résultats optimaux. Après des années de recherche et développement, le Bombardier a été créé.
...
À l\'aide d\'un équipement de ciblage à guidage laser et de bombes à plasma, le bombardier recherche et détruit tout mécanisme de défense qu\'il peut trouver. Dès que la propulsion hyperspatiale atteint le niveau 8, le bombardier est équipé du moteur hyperspatial et peut voler à des vitesses plus élevées.',
    ...
    'destroyer' => [
        'title' => 'Destructeur',
        'description' => 'Le destroyer est le roi des vaisseaux de guerre.',
        'description_long' => 'Le Destructeur est le résultat d’années de travail et de développement. Avec le développement des Étoiles de la mort, il a été décidé qu\'une classe de vaisseau était nécessaire pour se défendre contre une arme aussi massive. Grâce à ses capteurs de guidage améliorés, ses canons à ions multi-phalanges, ses canons Gauss et ses tourelles à plasma, le Destructeur s\'est avéré être l\'un des vaisseaux les plus redoutables jamais créés.

Parce que le destroyer est très grand, sa manœuvrabilité est sévèrement limitée, ce qui en fait davantage une station de combat qu\'un vaisseau de combat. Le manque de maniabilité est compensé par sa puissance de feu, mais sa construction et son fonctionnement coûtent également des quantités importantes de deutérium.',
    ],
    'deathstar' => [
...
Armé d\'un gigantesque canon à gravitons, le système d\'armes le plus avancé jamais créé dans l\'Univers, cet énorme vaisseau a non seulement la capacité de détruire des flottes et des défenses entières, mais également la capacité de détruire des lunes entières. Seuls les empires les plus avancés ont la capacité de construire un vaisseau de cette taille gigantesque.',
    ...
    'reaper' => [
        'title' => 'Faucheur',
        'description' => 'Le Faucheur est un puissant vaisseau de combat spécialisé dans les raids agressifs et la récolte de débris sur le terrain.',
        'description_long' => 'Le Faucheur représente le summum de l’ingénierie militaire de classe générale. Ce vaisseau lourdement armé a été conçu pour les commandants qui apprécient à la fois les prouesses au combat et la flexibilité tactique. Bien que son rôle principal soit le combat, le Faucheur est doté de soutes renforcées qui lui permettent de récolter les champs de débris après la bataille. Ses systèmes de ciblage avancés et son blindage lourd en font un adversaire redoutable, tandis que sa conception à double usage lui permet de créer et de profiter du carnage sur le champ de bataille. Le vaisseau est équipé d’une technologie d’armement de pointe et peut tenir tête à des vaisseaux beaucoup plus gros.',
    ],
    'rocket_launcher' => [
...
Après une bataille, il y a jusqu\'à 70 % de chances que les installations défensives défaillantes puissent être réutilisées.',
    ...
    'heavy_laser' => [
        ...
        'description_long' => 'L\'Artillerie laser lourde est une version pratique et améliorée de l\'Artillerie laser légère. Étant plus équilibrée que l\'Artillerie laser légère avec une composition d’alliage améliorée, il utilise des faisceaux plus puissants et plus denses et des systèmes de ciblage embarqués encore meilleurs.
...
Après une bataille, il y a jusqu\'à 70 % de chances que les installations défensives défaillantes puissent être réutilisées.',
    ...
    'detroid' => [
        'title' => 'DÉTROÏDE',
        'description' => 'Réduit le temps de construction des contrats de chantier spatial actuels de <b>:duration</b>.',
    ],
    'newtron' => [
        'title' => 'NEWTRON',
