...
Une fois qu’un niveau suffisant de technologie hyperspatiale est recherché, l’Hyperspace Drive n’est plus seulement une théorie. Chaque amélioration de ce moteur augmente la capacité de chargement de vos vaisseaux de 5 % de la valeur de base.',
    ],
    'plasma_technology' => [
...
Parce que le destroyer est très grand, sa manœuvrabilité est sévèrement limitée, ce qui en fait davantage une station de combat qu\'un vaisseau de combat. Le manque de maniabilité est compensé par sa puissance de feu, mais sa construction et son fonctionnement coûtent également des quantités importantes de deutérium.',
    ...
    'deathstar' => [
        ...
        'description_long' => 'Le Deathstar est le vaisseau le plus puissant jamais créé. Ce vaisseau de la taille d’une lune est le seul vaisseau visible à l’œil nu au sol. Au moment où vous le repérez, il est malheureusement trop tard pour faire quoi que ce soit.
...
Armé d\'un gigantesque canon à gravitons, le système d\'armes le plus avancé jamais créé dans l\'Univers, cet énorme vaisseau a non seulement la capacité de détruire des flottes et des défenses entières, mais également la capacité de détruire des lunes entières. Seuls les empires les plus avancés ont la capacité de construire un vaisseau de cette taille gigantesque.',
    ...
    'reaper' => [
        'title' => 'Moissonneuse',
        'description' => 'Le Reaper est un puissant vaisseau de combat spécialisé dans les raids agressifs et la récolte de débris sur le terrain.',
        'description_long' => 'Le Reaper représente le summum de l’ingénierie militaire de classe générale. Ce vaisseau lourdement armé a été conçu pour les commandants qui apprécient à la fois les prouesses au combat et la flexibilité tactique. Bien que son rôle principal soit le combat, le Reaper est doté de soutes renforcées qui lui permettent de récolter les champs de débris après la bataille. Ses systèmes de ciblage avancés et son blindage lourd en font un adversaire redoutable, tandis que sa conception à double usage lui permet de créer et de profiter du carnage sur le champ de bataille. Le vaisseau est équipé d’une technologie d’armement de pointe et peut tenir tête à des vaisseaux beaucoup plus gros.',
    ],
    'rocket_launcher' => [
