...
Ce message sera supprime dans 7 jours.',
    ...
    'return_of_fleet_with_resources' => [
        ...
        'body' => 'Votre flotte revient du :from au :to et a livré sa marchandise :
...
Deutérium : :deuterium',
    ...
    'return_of_fleet' => [
        'from' => 'Commandement de la flotte',
        'subject' => 'Retour d\'une flotte',
        'body' => 'Votre flotte revient du :from au :to.
...
Métal : :metal Cristal : :crystal Deutérium : :deuterium',
    ...
    'espionage_report' => [
        'from' => 'Commandement de la flotte',
        'subject' => 'Rapport d\'espionnage du :planet',
    ],
    'espionage_detected' => [
        'from' => 'Commandement de la flotte',
...
Chance de contre-espionnage : :chance%',
    ...
    'debris_field_harvest' => [
        'from' => 'Flotte',
        'subject' => 'Rapport de récolte de DF le :coordinates',
    ...
    'expedition_gain_resources' => [
        ...
        'body' => [
            ...
            '8' => 'Nous avons croisé un petit convoi de navires civils qui manquaient cruellement de vivres et de médicaments. En échange, nous avons reçu une belle quantité de ressources utiles.',
    ...
    'buddy_request_received' => [
        ...
        'body' => 'Vous avez reçu une nouvelle demande de contact de :sender_name.<span style="display⟦1⟧;">:buddy_request_id</span>',
    ],
...
Défenses détruites : :defenses_destroyed',
    ...
    'alliance_broadcast' => [
        'from' => ':sender_name',
        'subject' => '[:alliance_tag] Diffusion de l\'Alliance depuis le :sender_name',
        'body' => ':message',
    ],
