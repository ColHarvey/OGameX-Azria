...
Métal : :metal Cristal : :crystal Deutérium : :deuterium',
    ...
    'combat_rally_refused' => [
        ...
        'subject' => 'Flotte refusée au ralliement',
        'body' => 'Votre flotte n\'a pas pu rejoindre le combat en :coordinates et rentre à sa base.
Raison : :reason',
        'reasons' => [
            'origin_combat_locked' => 'sa planète de départ est engagée dans un combat',
            ...
            'already_engaged' => 'elle est déjà engagée ailleurs',
            'resolution_in_progress' => 'le combat était en cours de résolution',
            'own_fleet_coming_home' => 'une flotte à vous rentrait déjà',
            'no_combat_effect' => 'sa mission n\'a aucun effet sur ce combat',
            'undecided' => 'la règle de ce cas n\'est pas encore arrêtée',
            'position_no_longer_free' => 'la position n\'est plus libre',
            'wrong_target_body' => 'elle ne visait pas ce corps',
            'not_already_in_flight' => 'elle n\'était pas encore en vol à l\'ouverture',
            'rally_window_limit' => 'elle arrivait après la fin de la fenêtre de ralliement',
            'candidate_recalled' => 'elle a été rappelée avant la fermeture',
            'no_return_destination' => 'aucune destination de retour n\'a pu être établie',
        ],
    ],
    'combat_cancelled' => [
        'from' => 'Commandement de flotte',
...
Vos flottes rentrent à leur base. Référence de l\'incident : :reference',
        'causes' => [
            ...
            'administrative_decision' => 'décision de l\'administration',
    ...
    'lifeform_population_loss' => [
        ...
        'body' => 'L’attaque réussie contre :coordinates a coûté la vie à :lost habitants (:loss_percent % de la population exposée). Il en reste :survivors, protégés par le Bouclier planétaire (:protected_percent %) et l’abri.',
    ],
