...
return [
    ...
    'highscore' => [
        ...
        'rank_movement_up' => '{1}:places plaats gewonnen sinds de ranglijst van :date|[2,*]:places plaatsen gewonnen sinds de ranglijst van :date',
        'rank_movement_down' => '{1}:places plaats verloren sinds de ranglijst van :date|[2,*]:places plaatsen verloren sinds de ranglijst van :date',
        'rank_movement_stable' => 'Ongewijzigde positie sinds de ranglijst van :date',
        'rank_movement_new' => 'Nieuw',
        'rank_movement_new_tooltip' => 'Nieuwe vermelding: afwezig in de ranglijst van :date',
        'rank_movement_unavailable' => 'Referentie niet beschikbaar: er is nog geen eerdere ranglijst gepubliceerd',
    ...
    'announcement' => [
        ...
        'tab_bubble' => 'Melding op het overzicht',
        'message_explanation' => 'Dit bericht komt in de postvak in van alle spelers. Het publiceert geen melding.',
        'bubble_explanation' => 'Deze melding verschijnt op het overzicht, onder de afbeelding van de planeet. Een concept opslaan toont niets; alleen publiceren toont het aan spelers en laat het opnieuw verschijnen bij wie het had verborgen.',
        'subject' => 'Onderwerp',
        'message' => 'Bericht',
        'title' => 'Titel',
        'link_url' => 'Koppeling (optioneel)',
        'link_label' => 'Knoptekst (optioneel)',
        'link_hint' => 'Een spelpad dat met “/” begint, of een volledig http(s)-adres. Niets anders.',
        'link_refused' => 'Deze koppeling is geweigerd: gebruik een spelpad dat met “/” begint of een volledig http(s)-adres.',
        'dismissible' => 'Spelers deze aankondiging laten verbergen',
        'send_to_all' => 'Naar alle spelers sturen',
        'send_confirm' => 'Deze aankondiging naar alle spelers sturen?',
        'save_draft' => 'Concept opslaan',
        'preview' => 'Voorbeeld',
        'publish' => 'Een nieuwe aankondiging publiceren',
        'publish_confirm' => 'Een nieuwe aankondiging publiceren? Ze verschijnt opnieuw bij spelers die de vorige hadden verborgen.',
        'enable' => 'Melding inschakelen',
        'disable' => 'Melding uitschakelen',
        'toggle_hint' => 'In- of uitschakelen publiceert niets en wist geen enkele verberging.',
        'draft_saved' => 'Concept opgeslagen. Er is niets gepubliceerd.',
        'published' => 'Aankondiging gepubliceerd (versie :version).',
        'enabled' => 'De melding wordt aan spelers getoond.',
        'disabled' => 'De melding is verborgen.',
        'state' => 'Status:',
        'state_enabled' => 'getoond',
        'state_disabled' => 'verborgen',
        'state_version' => 'gepubliceerde versie: :version',
        'state_never_published' => 'nooit gepubliceerd',
        'badge' => 'Aankondiging',
        'preview_title' => 'Voorbeeld van de aankondiging',
        'preview_note' => 'Er wordt niets gepubliceerd: spelers zien deze pagina niet. Ze toont hoe de melding eruitziet na publicatie.',
        'region_label' => 'Aankondiging van de beheerder',
        'dismiss' => 'Deze aankondiging verbergen',
        'default_link_label' => 'Meer weten',
    ],
