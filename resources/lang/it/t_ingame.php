...
return [
    ...
    'empire' => [
        ...
        'group_supply' => 'Production',
        'group_station' => 'Facilities',
        'group_research' => 'Research',
        'group_shipyard' => 'Shipyard',
        'group_defense' => 'Defence',
        'group_lifeforms' => 'Lifeforms',
        'res_metal' => 'Metal',
        'res_crystal' => 'Crystal',
        'res_deuterium' => 'Deuterium',
        'res_energy' => 'Energy',
        'energy' => 'Energy',
        'energy_tooltip' => 'Production :produced, consumption :consumed',
        'diameter' => 'Diameter',
        'temperature' => ':min °C to :max °C',
        'storage_tooltip' => 'Capacity :capacity',
        'building_in_progress' => 'Under construction, :time remaining',
        'building_queued' => 'In the build queue',
        'research_in_progress' => 'Research in progress',
        'research_queued' => 'Research queued',
        'units_in_progress' => 'Being built in the shipyard',
        'lf_species' => 'Species',
        'lf_species_full' => 'Account species: a single one, for every planet',
        'lf_population' => 'Population',
        'lf_population_full' => 'Population and living space',
        'lf_food' => 'Food',
        'lf_food_full' => 'Food in store, capacity and hourly balance',
        'lf_effects' => 'Active effects',
        'lf_effects_full' => 'Effects actually applied to the account, across all planets',
        'lifeform_absent' => 'No lifeform on this body',
        'lifeform_held' => ' — suspended, battle in progress',
        'lifeform_hungry' => ' — starving',
        'lifeform_full' => ' — population at its maximum',
        'population_tooltip' => 'Living space :space, growth :growth per hour',
        'food_tooltip' => 'Capacity :capacity, balance :balance per hour',
        'tech_active' => 'Slot :slot, active: it contributes to the account effects.',
        'tech_selected' => 'Slot :slot, selected but without effect: the tier is not open.',
        'tech_developed' => 'Researched without a slot: no effect.',
        'tech_none' => 'Neither slot nor level.',
        'tech_in_research' => 'Research under way towards level :target.',
        'tech_legend' => 'Reading: 12 = active · (12) = selected without effect · [12] = researched without a slot · → 13 = research under way, which may apply to an already active technology.',
        'effects_are_account_wide' => 'Technology effects belong to the account: see the Total column.',
        'species_is_account_wide' => 'A single species per account, for every planet.',
        'average_level' => 'Average level across :count bodies',
        'average_level_short' => 'Average level across :count bodies',
        'active_on' => 'active :active / :count',
        'active_on_tooltip' => 'Bodies where this technology actually contributes. Shares add up account-wide and are then capped: they do not add up column by column.',
        'effect_capped' => '(capped)',
        'effect_count' => ':count effect(s)',
        'no_effect' => 'No active effect',
        'per_hour' => 'Per hour',
        'per_day' => 'Per day',
        'per_week' => 'Per week',
        'taken_at' => 'Server snapshot:',
        'refresh' => 'Refresh',
        'refresh_failed' => '— refresh failed, data kept',
        'no_moons' => 'No moon in your empire',
        'no_moons_hint' => 'This tab will fill up as soon as one of your planets has a moon.',
    ],
    'layout' => [
        // Barra intestazione
        'player'                    => 'Giocatore',
        ...
        'menu_empire' => 'Empire',
        'menu_empire_title' => 'All your planets and moons on a single page',
    ...
    'highscore' => [
        ...
        'lifeform' => 'Forme di vita',
        'lifeform_economy' => 'Economia delle forme di vita',
        'lifeform_technology' => 'Tecnologia delle forme di vita',
        'lifeform_share' => 'Di cui forme di vita: :points punti',
        'cumulative_since' => 'Cumulato dal :date',
        'refreshed_at' => 'Aggiornato il :date',
        'rank_movement_up' => '{1}:places posizione guadagnata dalla classifica del :date|[2,*]:places posizioni guadagnate dalla classifica del :date',
        'rank_movement_down' => '{1}:places posizione persa dalla classifica del :date|[2,*]:places posizioni perse dalla classifica del :date',
        'rank_movement_stable' => 'Posizione invariata dalla classifica del :date',
        'rank_movement_new' => 'Nuovo',
        'rank_movement_new_tooltip' => 'Nuova voce: assente dalla classifica del :date',
        'rank_movement_unavailable' => 'Riferimento non disponibile: nessuna classifica precedente è ancora stata pubblicata',
    ...
    'announcement' => [
        ...
        'tab_bubble' => 'Riquadro nella panoramica',
        'message_explanation' => 'Questo messaggio arriva nella casella di posta in gioco di tutti i giocatori. Non pubblica alcun riquadro.',
        'bubble_explanation' => 'Questo riquadro compare nella panoramica, sotto l’immagine del pianeta. Salvare una bozza non mostra nulla; solo la pubblicazione lo mostra ai giocatori e lo fa riapparire a chi lo aveva nascosto.',
        'subject' => 'Oggetto',
        'message' => 'Messaggio',
        'title' => 'Titolo',
        'link_url' => 'Collegamento (facoltativo)',
        'link_label' => 'Etichetta del pulsante (facoltativa)',
        'link_hint' => 'Un percorso del gioco che inizia con “/”, oppure un indirizzo http(s) completo. Nient’altro.',
        'link_refused' => 'Collegamento rifiutato: usa un percorso del gioco che inizia con “/” o un indirizzo http(s) completo.',
        'dismissible' => 'Consenti ai giocatori di nascondere questo annuncio',
        'send_to_all' => 'Invia a tutti i giocatori',
        'send_confirm' => 'Inviare questo annuncio a tutti i giocatori?',
        'save_draft' => 'Salva la bozza',
        'preview' => 'Anteprima',
        'publish' => 'Pubblica un nuovo annuncio',
        'publish_confirm' => 'Pubblicare un nuovo annuncio? Riapparira ai giocatori che avevano nascosto il precedente.',
        'enable' => 'Attiva il riquadro',
        'disable' => 'Disattiva il riquadro',
        'toggle_hint' => 'Attivare o disattivare non pubblica nulla e non cancella alcun nascondimento.',
        'draft_saved' => 'Bozza salvata. Non e stato pubblicato nulla.',
        'published' => 'Annuncio pubblicato (versione :version).',
        'enabled' => 'Il riquadro e mostrato ai giocatori.',
        'disabled' => 'Il riquadro e nascosto.',
        'state' => 'Stato:',
        'state_enabled' => 'mostrato',
        'state_disabled' => 'nascosto',
        'state_version' => 'versione pubblicata: :version',
        'state_never_published' => 'mai pubblicato',
        'badge' => 'Annuncio',
        'preview_title' => 'Anteprima dell’annuncio',
        'preview_note' => 'Non viene pubblicato nulla: i giocatori non vedono questa pagina. Mostra come apparirà il riquadro una volta pubblicato.',
        'region_label' => 'Annuncio dell’amministrazione',
        'dismiss' => 'Nascondi questo annuncio',
        'default_link_label' => 'Scopri di piu',
    ],
