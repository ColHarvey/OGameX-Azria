...
Since the Space Dock floats in orbit, it does not require a planet field.',
    ...
    // Repairing damaged survivors at the space dock. Separate from wreck recovery, which stays free.
    'hull_repair' => [
        'title' => 'Fleet repair',
        'intro' => 'The space dock can restore ships damaged in battle, for a price.',
        'fleet_line' => ':total :vaisseau, of which :damaged damaged',
        'level_line' => ':count at :percent % hull',
        'quote' => 'Quote',
        'start' => 'Start repairs',
        'cancel' => 'Cancel repairs',
        'in_progress' => 'Repairs in progress: :percent %',
        'refund_notice' => 'Cancelling keeps the work already done and refunds the rest.',
        'refused' => [
            'no_dock' => 'This body has no space dock.',
            'dock_busy' => 'The space dock is already repairing a fleet.',
            'nothing_damaged' => 'No damaged ships on this body.',
            'not_enough_resources' => 'Not enough resources for this quote.',
            'quote_stale' => 'The quote is no longer valid. Please start over.',
            'units_gone' => 'Those ships are no longer available.',
            'not_owner' => 'This body is not yours.',
            'body_gone' => 'This body no longer exists.',
            'nothing_selected' => 'No ship selected.',
            'no_order' => 'No repairs in progress.',
            'disabled' => 'Fleet repair is not enabled on this universe.',
        ],
    ],
];
