...
Improved fleet escape rate',
    ...
    'events' => [
        ...
        'period' => 'Event running from :start to :end inclusive. Missions are renewed every day at midnight.',
        'tritium_total' => ':tritium tritium out of :max',
        'section_missions' => 'Today\'s missions',
        'section_ranks' => 'Reward ranks',
        'ranks_hint' => 'Tritium is never spent: reaching a threshold unlocks the rank, and your total stays put for the next ones.',
        'planet_warning' => 'Resources are credited to your current planet: :planet. Items go to your inventory.',
        'claim' => 'Claim',
        'claimed' => 'Claimed',
        'in_progress' => 'In progress',
        'claim_success' => 'Mission completed, tritium credited.',
        'rank_claim_success' => 'Reward granted.',
        'rank_title' => 'Rank :rank',
        'rank_threshold' => ':tritium tritium',
        'rank_claimed' => 'Chosen reward: :reward',
        ...
        'mission_chat' => 'Send a message in the chat',
        'mission_alliance' => 'Be a member of an alliance with at least :target members',
        'mission_shop' => 'Buy an item from the shop',
        'mission_halving' => 'Immediately finish a construction with dark matter',
        'error_not_running' => 'No event is running.',
        'error_unknown_mission' => 'This mission is not part of your draw for today.',
        'error_not_done' => 'This mission is not completed yet.',
        'error_already_claimed' => 'You have already claimed this mission today.',
