...
return [
    ...
    'alliance' => [
        ...
        'msg_rank_deleted'              => 'Rank deleted successfully',
        ...
        'msg_transfer_error'            => 'Failed to transfer the alliance',
        'no_transfer_candidates'        => 'No member holds the `Right hand` permission. Grant it to a rank to be able to hand over the alliance.',
    ...
    'premium' => [
        ...
        'hire_commander_tooltip'     => 'Hire commander|Building queue raised from 4 to 8',
        'hire_admiral_tooltip'       => 'Hire admiral|Max. fleet slots +2,
Max. expeditions +1,
Improved fleet escape rate',
        'hire_engineer_tooltip'      => 'Hire engineer|+10% energy production, defence rebuilt at 85% instead of 70%',
        ...
        'benefit_resources' => '+2% metal, crystal and deuterium',
        'benefit_resources_title' => 'With all five officers active, all your mines produce 2% more.',
        'hire_title' => 'Hire :officer for :days days (:price DM)',
        'btn_days' => ':days days',
        'btn_price' => ':price DM',
        'already_owned' => 'You already own this officer, until :date.',
        'officer_buy_for' => ':days days - :price DM',
        'not_enough' => 'Not enough dark matter for this officer.',
        'staff_explained' => 'Hire all five officers to activate the commanding staff bonus. You have :current of :max.',
        'choose_officer' => 'Pick an officer to see the bonuses he provides',
        'choose_officer_hint' => 'Click an officer portrait above to see his effects, his remaining time and hire him.',
        'officer_commander' => 'Commander',
        'officer_admiral' => 'Admiral',
        'officer_engineer' => 'Engineer',
        'officer_geologist' => 'Geologist',
        'officer_technocrat' => 'Technocrat',
        'effects_commander' => 'Building queue raised from 4 to 8',
        'effects_admiral' => '+2 fleet slots, +1 expedition, 3-wave tactical retreat',
        'effects_engineer' => '+10% energy production, defence rebuilt at 85% instead of 70%',
        'effects_geologist' => '+10% metal, crystal and deuterium production',
        'effects_technocrat' => '-25% research time, +2 espionage levels',
        ...
        'table_status' => 'Status',
        'table_hire' => 'Hire',
        'hire_button' => ':days d - :price DM',
        'hire_success' => 'Officer hired. The effects apply immediately.',
        'transaction_description' => 'Hired: :officer (:days days)',
        'error_unknown_officer' => 'This officer does not exist.',
        'error_unknown_duration' => 'This duration is not offered.',
        'error_not_enough_dark_matter' => 'Not enough dark matter for this hire.',
    ],
    ...
    'shop' => [
        ...
        'btn_buy'                       => 'Buy',
        'confirm_buy'                   => 'Buy :item for :price dark matter?',
        'msg_unknown_item'              => 'Unknown item',
        'msg_not_enough_dark_matter'    => 'You do not have enough dark matter',
        'msg_item_not_owned'            => 'You do not own this item',
        'msg_nothing_in_progress_building' => 'No building is under construction on this planet',
        'msg_nothing_in_progress_unit'  => 'Nothing is being built at this planet\'s shipyard',
        'msg_nothing_in_progress_research' => 'No research is in progress',
        'msg_bought'                    => ':item added to your inventory',
        'msg_used'                      => ':item used: :duration less to wait',
        'msg_buy_error'                 => 'The purchase failed',
        'msg_use_error'                 => 'Using the item failed',
        'empty_inventory'               => 'Your inventory is empty. Buy an item in the shop, or find one on an expedition.',
    ...
    // ── Technology detail panel (ajax/object) ──
    'ajax_object' => [
        'build'                    => 'Build',
    ...
    // ── Server settings overlay (in-game) ──
    ...
    'rewards' => [
        'page_title' => 'Rewards',
        'hint' => 'One reward is made available each day during your first week. They are never granted automatically: click "Claim" to collect them. They remain available for as long as you have not claimed them.',
        'section_available' => 'Available rewards',
        'section_locked' => 'Upcoming rewards',
        'section_collected' => 'Collected rewards',
        'btn_claim' => 'Claim',
        'btn_locked' => 'Available in :days d',
        'btn_unavailable' => 'Coming soon',
        'btn_claimed' => 'Claimed',
        'none_available' => 'No reward to claim at the moment.',
        'none_collected' => 'You have not claimed any reward yet.',
        'claim_success' => 'Reward claimed. It has been credited to your current planet.',
        'error_unknown' => 'This reward does not exist.',
        'error_unavailable' => 'This reward is not available yet on this universe.',
        'error_locked' => 'This reward is not unlocked yet.',
        'error_already_claimed' => 'You have already claimed this reward.',
        'transaction_description' => 'Starter aid - day :day',
        'greeting' => 'Greetings, emperor :name!',
        'good_luck' => 'Good luck!',
        'signature' => 'The Azria team',
        'gain_metal' => 'metal',
        'gain_crystal' => 'crystal',
        'gain_deuterium' => 'deuterium',
        'gain_dark_matter' => 'dark matter',
        'gain_rocket_launcher' => 'rocket launchers',
        'day_1_title' => 'Let\'s go Emperor',
        'day_1_text' => 'The supplies from your colony ship have been unloaded and are now available to help develop your world. The perfect time to drive forward the improvements to your empire!',
        'day_2_title' => 'The colony is growing!',
        'day_2_text' => 'Your subordinates want to make themselves useful. Some dark matter has been allocated to you: use it to speed up your ongoing construction. Increase your production and your empire will soon flourish.',
        'day_3_title' => 'Supply and demand',
        'day_3_text' => 'When the metal storage is overflowing and the assembly line stands still because there are no more crystals, it is a good time to pay a visit to the resource merchant. Here is something to trade with: check out his offers now.',
        'day_4_title' => 'Progress through technology',
        'day_4_text' => 'Your colony has to be protected from enemy emperors. Rocket Launchers are an effective means of fighting back against attacking space ships. Protect your new home!',
        'day_5_title' => 'Progress through technology',
        'day_5_text' => 'Our scientists are racking their brains. How about we support them a little in their hard work? This dark matter reserve should be of good use to speed up your research.',
        'day_6_title' => 'Conquer outer space',
        'day_6_text' => 'We need to strengthen our forces if we do not want to end up being our enemy\'s play toy. With this dark matter, shipyard production can be accelerated: the fleet will be ready to go at all times.',
        'day_7_title' => 'Expansion of the empire',
