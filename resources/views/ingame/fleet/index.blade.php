...
@section('content')
    ...
    <div id="fleetdispatchcomponent" class="maincontent">
        <script type="text/javascript">
            ...
            var orderNames = {
                "15": @json(__('t_ingame.fleet.mission_expedition')),
                "7": @json(__('t_ingame.fleet.mission_colonise')),
                "8": @json(__('t_ingame.fleet.mission_recycle')),
                "3": @json(__('t_ingame.fleet.mission_transport')),
                "4": @json(__('t_ingame.fleet.mission_deploy')),
                "6": @json(__('t_ingame.fleet.mission_espionage')),
                "5": @json(__('t_ingame.fleet.mission_acs_defend')),
                "1": @json(__('t_ingame.fleet.mission_attack')),
                "2": @json(__('t_ingame.fleet.mission_acs_attack')),
                "9": @json(__('t_ingame.fleet.mission_destroy_moon'))
            };
            var orderDescriptions = {
                "1": @json(__('t_ingame.fleet.desc_attack')),
                "2": @json(__('t_ingame.fleet.desc_acs_attack')),
                "3": @json(__('t_ingame.fleet.desc_transport')),
                "4": @json(__('t_ingame.fleet.desc_deploy')),
                "5": @json(__('t_ingame.fleet.desc_acs_defend')),
                "6": @json(__('t_ingame.fleet.desc_espionage')),
                "7": @json(__('t_ingame.fleet.desc_colonise')),
                "8": @json(__('t_ingame.fleet.desc_recycle')),
                "9": @json(__('t_ingame.fleet.desc_destroy_moon')),
                "15": @json(__('t_ingame.fleet.desc_expedition'))
            };
            ...
            var loca = {
                "LOCA_FLEET_TITLE_MOVEMENTS": @json(__('t_ingame.fleet.to_movement')),
                "LOCA_FLEET_MOVEMENT": @json(__('t_ingame.fleet.movement_title')),
                "LOCA_FLEET_EDIT_STANDARTFLEET": @json(__('t_ingame.fleet.edit_standard_fleets')),
                "LOCA_FLEET_STANDARD": @json(__('t_ingame.fleet.standard_fleets')),
                "LOCA_FLEET_HEADLINE_ONE": @json(__('t_ingame.fleet.dispatch_1_title')),
                "LOCA_FLEET_TOOLTIPP_SLOTS": @json(__('t_ingame.fleet.tooltip_slots')),
                "LOCA_FLEET_FLEETSLOTS": @json(__('t_ingame.fleet.fleets')),
                "LOCA_FLEET_NO_FREE_SLOTS": @json(__('t_ingame.fleet.no_free_slots')),
                "LOCA_FLEETSENDING_NO_TARGET": @json(__('t_ingame.fleet.no_target')),
                "LOCA_FLEET_TOOLTIPP_EXP_SLOTS": @json(__('t_ingame.fleet.tooltip_exp_slots')),
                "LOCA_FLEET_EXPEDITIONS": @json(__('t_ingame.fleet.expeditions')),
                "LOCA_ALL_NEVER": @json(__('t_ingame.fleet.never')),
                "LOCA_FLEET_SEND_NOTAVAILABLE": @json(__('t_ingame.fleet.dispatch_impossible')),
                "LOCA_FLEET_NO_SHIPS_ON_PLANET": @json(__('t_ingame.fleet.no_ships')),
                "LOCA_SHIPYARD_HEADLINE_BATTLESHIPS": @json(__('t_ingame.fleet.combat_ships')),
                "LOCA_SHIPYARD_HEADLINE_CIVILSHIPS": @json(__('t_ingame.fleet.civil_ships')),
                "LOCA_FLEET_SELECT_SHIPS_ALL": @json(__('t_ingame.fleet.select_all_ships')),
                "LOCA_FLEET_SELECTION_RESET": @json(__('t_ingame.fleet.reset_choice')),
                "LOCA_API_FLEET_DATA": @json(__('t_ingame.fleet.api_data')),
                "LOCA_ALL_BUTTON_FORWARD": @json(__('t_ingame.fleet.continue')),
                "LOCA_FLEET_NO_SELECTION": @json(__('t_ingame.fleet.no_selection')),
                "LOCA_ALL_TACTICAL_RETREAT": @json(__('t_ingame.fleet.tactical_retreat')),
                "LOCA_FLEET1_TACTICAL_RETREAT_CONSUMPTION_TOOLTIP": @json(__('t_ingame.fleet.tactical_retreat_tooltip')),
                "LOCA_FLEET_FUEL_CONSUMPTION": @json(__('t_ingame.fleet.deuterium_consumption')),
                "LOCA_FLEET_ERROR_OWN_VACATION": @json(__('t_ingame.fleet.vacation_error')),
                "LOCA_FLEET_CURRENTLY_OCCUPIED": @json(__('t_ingame.fleet.in_combat')),
                "LOCA_FLEET_FREE_MARKET_SLOTS": @json(__('t_ingame.fleet.market_slots')),
                "LOCA_FLEET_TOOLTIPP_FREE_MARKET_SLOTS": @json(__('t_ingame.fleet.tooltip_market_slots')),
                "LOCA_FLEET_HEADLINE_TWO": @json(__('t_ingame.fleet.dispatch_2_title')),
                "LOCA_FLEET_TAKEOFF_PLACE": @json(__('t_ingame.fleet.origin')),
                "LOCA_FLEET_TARGET_PLACE": @json(__('t_ingame.fleet.destination')),
                "LOCA_ALL_PLANET": @json(__('t_ingame.fleet.planet')),
                "LOCA_ALL_MOON": @json(__('t_ingame.fleet.moon')),
                "LOCA_FLEET_COORDINATES": @json(__('t_ingame.fleet.coordinates')),
                "LOCA_FLEET_DISTANCE": @json(__('t_ingame.fleet.distance')),
                "LOCA_FLEET_DEBRIS": @json(__('t_ingame.fleet.debris_field_lower')),
                "LOCA_FLEET_SHORTLINKS": @json(__('t_ingame.fleet.shortcuts')),
                "LOCA_FLEET_FIGHT_ASSOCIATION": @json(__('t_ingame.fleet.combat_forces')),
                "LOCA_FLEET_BRIEFING": @json(__('t_ingame.fleet.briefing')),
                "LOCA_FLEET_DURATION_ONEWAY": @json(__('t_ingame.fleet.flight_duration')),
                "LOCA_FLEET_SPEED": @json(__('t_ingame.fleet.speed')),
                "LOCA_FLEET_SPEED_MAX_SHORT": @json(__('t_ingame.fleet.max_abbr')),
                "LOCA_FLEET_ARRIVAL": @json(__('t_ingame.fleet.arrival')),
                "LOCA_FLEET_TIME_CLOCK": @json(__('t_ingame.fleet.clock')),
                "LOCA_FLEET_RETURN": @json(__('t_ingame.fleet.return_trip')),
                "LOCA_FLEET_HOLD_FREE": @json(__('t_ingame.fleet.empty_cargobays')),
                "LOCA_ALL_BUTTON_BACK": @json(__('t_ingame.fleet.back')),
                "LOCA_FLEET_PLANET_UNHABITATED": @json(__('t_ingame.fleet.uninhabited_planet')),
                "LOCA_FLEET_NO_DEBIRS_FIELD": @json(__('t_ingame.fleet.no_debris_field')),
                "LOCA_FLEET_PLAYER_UMODE": @json(__('t_ingame.fleet.player_vacation')),
                "LOCA_FLEET_ADMIN": @json(__('t_ingame.fleet.admin_gm')),
                "LOCA_ALL_NOOBSECURE": @json(__('t_ingame.fleet.noob_protection')),
                "LOCA_GALAXY_ERROR_STRONG": @json(__('t_ingame.fleet.player_too_strong')),
                "LOCA_FLEET_NO_MOON": @json(__('t_ingame.fleet.no_moon')),
                "LOCA_FLEET_NO_RECYCLER": @json(__('t_ingame.fleet.no_recycler')),
                "LOCA_ALL_NO_EVENT": @json(__('t_ingame.fleet.no_events')),
                "LOCA_PLANETMOVE_ERROR_ALREADY_RESERVED": @json(__('t_ingame.fleet.planet_already_reserved')),
                "LOCA_FLEET_ERROR_TARGET_MSG": @json(__('t_ingame.fleet.cannot_send_to_target')),
                "LOCA_FLEETSENDING_NOT_ENOUGH_FOIL": @json(__('t_ingame.fleet.not_enough_deuterium')),
                "LOCA_FLEET_HEADLINE_THREE": @json(__('t_ingame.fleet.dispatch_3_title')),
                "LOCA_FLEET_TARGET_FOR_MISSION": @json(__('t_ingame.fleet.select_mission')),
                "LOCA_FLEET_MISSION": @json(__('t_ingame.fleet.mission_label')),
                "LOCA_FLEET_RESOURCE_LOAD": @json(__('t_ingame.fleet.load_resources')),
                "LOCA_FLEET_SELECTION_NOT_AVAILABLE": @json(__('t_ingame.fleet.cannot_start_mission')),
                "LOCA_FLEET_RETREAT_AFTER_DEFENDER_RETREAT_TOOLTIP": @json(__('t_ingame.fleet.retreat_tooltip')),
                "LOCA_FLEET_RETREAT_AFTER_DEFENDER_RETREAT": @json(__('t_ingame.fleet.retreat_on_defender')),
                "LOCA_FLEET_TARGET": @json(__('t_ingame.fleet.target_label')),
                "LOCA_FLEET_DURATION_FEDERATION": @json(__('t_ingame.fleet.federation_duration')),
                "LOCA_ALL_TIME_HOUR": @json(__('t_ingame.fleet.hour_abbr')),
                "LOCA_FLEET_HOLD_TIME": @json(__('t_ingame.fleet.hold_time')),
                "LOCA_FLEET_EXPEDITION_TIME": @json(__('t_ingame.fleet.expedition_duration')),
                "LOCA_ALL_METAL": @json(__('t_ingame.fleet.metal')),
                "LOCA_ALL_CRYSTAL": @json(__('t_ingame.fleet.crystal')),
                "LOCA_ALL_DEUTERIUM": @json(__('t_ingame.fleet.deuterium')),
                // "LOCA_ALL_FOOD": "Food",
                "LOCA_FLEET_LOAD_ROOM": @json(__('t_ingame.fleet.cargo_bay')),
                "LOCA_FLEET_CARGO_SPACE": @json(__('t_ingame.fleet.cargo_space')),
                "LOCA_FLEET_SEND": @json(__('t_ingame.fleet.send_fleet')),
                "LOCA_ALL_NETWORK_ATTENTION": @json(__('t_ingame.shared.caution')),
                "LOCA_PLANETMOVE_BREAKUP_WARNING": @json(__('t_ingame.buildings.planet_move_warning')),
                "LOCA_ALL_YES": @json(__('t_ingame.shared.yes')),
                "LOCA_ALL_NO": @json(__('t_ingame.shared.no')),
                "LOCA_ALL_NOTICE": @json(__('t_ingame.buildings.loca_notice')),
                "LOCA_FLEETSENDING_MAX_PLANET_WARNING": @json(__('t_ingame.fleet.max_planet_warning')),
                "LOCA_ALL_PLAYER": @json(__('t_ingame.fleet.player_label')),
                "LOCA_FLEET_RESOURCES_ALL_LOAD": @json(__('t_ingame.fleet.load_all_resources')),
                "LOCA_FLEET_RESOURCES_ALL": @json(__('t_ingame.fleet.all_resources')),
                "LOCA_NETWORK_USERNAME": @json(__('t_ingame.fleet.player_name')),
                "LOCA_EVENTH_ENEMY_INFINITELY_SPACE": @json(__('t_ingame.fleet.deep_space')),
                "LOCA_FLEETSENDING_NO_MISSION_SELECTED": @json(__('t_ingame.fleet.no_mission_selected')),
                "LOCA_EMPTY_SYSTEMS": @json(__('t_ingame.fleet.empty_systems')),
                "LOCA_INACTIVE_SYSTEMS": @json(__('t_ingame.fleet.inactive_systems')),
            ...
            var locadyn = {
                ...
                "localBashWarning": @json(__('t_ingame.fleet.bash_warning')),
                "locaOfficerbonusTooltipp": @json(__('t_ingame.fleet.admiral_slot_bonus'))
            };
            var errorCodeMap = {
                "601": @json(__('t_ingame.fleet.err_generic')),
                "602": @json(__('t_ingame.fleet.err_no_moon')),
                "603": @json(__('t_ingame.fleet.err_newbie_protection')),
                "604": @json(__('t_ingame.fleet.err_too_strong')),
                "605": @json(__('t_ingame.fleet.err_vacation_mode')),
                "606": @json(__('t_ingame.fleet.err_own_vacation')),
                "610": @json(__('t_ingame.fleet.err_not_enough_ships')),
                "611": @json(__('t_ingame.fleet.err_no_ships')),
                "612": @json(__('t_ingame.fleet.err_no_slots')),
                "613": @json(__('t_ingame.fleet.err_no_deuterium')),
                "614": @json(__('t_ingame.fleet.err_no_planet')),
                "615": @json(__('t_ingame.fleet.err_no_cargo')),
                "616": @json(__('t_ingame.fleet.err_multi_alarm')),
                "617": @json(__('t_ingame.fleet.admin_gm')),
                "618": @json(__('t_ingame.fleet.err_attack_ban'))
            };
