    ...
    <div id="lfsettingscomponent" class="maincontent">
        <div id="lfsettings">
            ...
            <div id="technologies">
                ...
                <div class="lfsettingsContentWrapper informationalContent" id="lifeform-discoveries-summary" style="align-items: stretch;">
                    <h3 class="textBeefy" style="color: #6f9fc8; margin: 0 0 8px 0;">{{ __('t_lifeforms_ui.discoveries.title') }} — {{ $species_name }}</h3>
                ...
                <div class="lfsettingsContentWrapper informationalContent" id="lifeform-discoveries-launch" style="align-items: stretch;">
                    <h3 class="textBeefy" style="color: #6f9fc8; margin: 0 0 8px 0;">{{ __('t_lifeforms_ui.discoveries.launch_title') }}</h3>
                ...
                <div class="lfsettingsContentWrapper informationalContent" id="lifeform-discoveries-running" style="align-items: stretch;">
                    <h3 class="textBeefy" style="color: #6f9fc8; margin: 0 0 8px 0;">{{ __('t_lifeforms_ui.discoveries.running_title') }}</h3>
                    @if (count($running) === 0)
                ...
                <div class="lfsettingsContentWrapper informationalContent" id="lifeform-discoveries-history" style="align-items: stretch;">
                    <h3 class="textBeefy" style="color: #6f9fc8; margin: 0 0 8px 0;">{{ __('t_lifeforms_ui.discoveries.history_title') }}</h3>
                    @if (count($history) === 0)
